...
BEGIN
    ...
    RETURN jsonb_build_object('success', true, 'message', '发货成功', 'tracking_no', p_tracking_no);
END;
$$;
...
BEGIN
    ...
    RETURN jsonb_build_object('success', true, 'message', '确认收货成功', 'seller_earnings', v_seller_earnings);
END;
$$;
...
BEGIN
    ...
    RETURN jsonb_build_object('success', true, 'message', '退款申请已提交', 'refund_amount', v_refund_amount);
END;
$$;
